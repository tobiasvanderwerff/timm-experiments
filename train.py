...
Original link: https://github.com/huggingface/pytorch-image-models/blob/e748805be31318da1a0e34b61294704666f50397/train.py
...
def main():
    ...
    ############### TvdW Start ###############
    use_conditional_batchnorm = True
    if use_conditional_batchnorm:
        # Freeze all layers
